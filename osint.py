...
print(Fore.YELLOW + '83 73 77 80 76 69  79 83 73 78 84')

query = input(Back.BLACK + Fore.YELLOW + 'Find: ' + Back.RESET + Fore.WHITE)
results = input(Back.BLACK + Fore.YELLOW + 'Results: ' + Back.RESET + Fore.WHITE)

print(Fore.GREEN + '[*] Searching... ' + query)

for url in search(query, stop = int(results)):
